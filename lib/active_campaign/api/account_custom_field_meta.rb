...
module ActiveCampaign
  module API
    ...
    module AccountCustomFieldMeta
      ...
      def create_account_custom_field_meta(params)
        post('accountCustomFieldMeta', account_custom_field_metum: params)
      end
      ...
      # @return [Hash]
      #
      def show_account_custom_field_meta(id)
      ...
      # @return [Array<Hash>]
      #
      def show_account_custom_field_metas(search = nil, **params)
        params[:search] = search

        get('accountCustomFieldMeta', params)
      end
      ...
      #
      # rubocop:enable Layout/LineLength
      def update_account_custom_field_meta(id, params)
        put("accountCustomFieldMeta/#{id}", account_custom_field_meta: params)
      end
      ...
      # @return [Hash]
      #
      def move_account_custom_field_meta(id, stage)
        put("accountCustomFieldMeta/#{id}/accounts", account: { stage: stage })
      end
      ...
      # @return [Hash]
      #
      def delete_account_custom_field_meta(id)
